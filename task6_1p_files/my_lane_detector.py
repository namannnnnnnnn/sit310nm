...
class LaneDetector:
    def __init__(self):
        ...
        # Your robot camera topic
        self.image_topic = "/mybota002443/camera_node/image/compressed"
    ...
    def image_callback(self, msg):
        ...
        # -------------------------------
        # 1. Crop image to show road only
        # -------------------------------
        # Duckietown image is normally 480x640.
        # This keeps lower part of image where road is visible.
        ...
        # -------------------------------
        # 5. Clean masks using erosion/dilation
        # -------------------------------
        ...
        # -------------------------------
        # 7. Hough Transform for white lines
        # -------------------------------
        ...
        # -------------------------------
        # 8. Hough Transform for yellow lines
        # -------------------------------
        ...
        # -------------------------------
        # 9. Draw detected lines on cropped image
        # -------------------------------
        hough_output = cropped.copy()

        # Blue lines show white lane detection
        hough_output = self.draw_lines(hough_output, white_lines, (255, 0, 0))

        # Red lines show yellow lane detection
